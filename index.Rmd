...
[ Thought: Could we make this an actual example workflow, from SEN2 before and after maybe? ]
...
---
 ...
 [ Thought: I think we maybe just focus on the SEN2 pipeline here, go over the structure of the repo, and some detail in how the code works? Perhaps the before/after diagram from above comes in here? Could bring in specific examples from the others if useful/unique? ]
...
RAP page of the guidance website - LINK

--

Template code repository - LINK

--

Expansion of data-screener app - LINK
